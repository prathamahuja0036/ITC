            ...
            <div className="navbar">
                <div className="navbar1 d-sm-none d-md-none d-lg-flex">
                    <div className="navbar1-left-side">
                        <p><i class="fas fa-map-marker-alt me-1 text-orange"></i> <a href="#" class="text-white">Hisar,Haryana</a></p>
                        <p><i class="fas fa-envelope me-2 text-orange"></i><a href="#" class="text-white">Indianthalicompany@gmail.com</a></p>
                    </div>
                    <div className="navbar1-right-side">
                        ...
                        <a href="AboutUs.js" class="text-white"><p class="text-white">About Us</p></a>
                    </div>
                </div>
